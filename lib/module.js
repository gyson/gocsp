...
(function moduleScript () {
    ...
    // go.undefine = function (filename) {
    //     delete defining_modules[filename];
    //     delete defined_modules[filename];
    // };
    ...
    // go.unexport = function (filename) {
    //     delete requiring_modules[filename];
    //     delete required_modules[filename];
    // };
    ...
    go.engine["js"] = function (filename, file) {
        return new go.Promise(function (resolve, reject) {
    ...
    go.engine["json"] = function (filename, file) {
