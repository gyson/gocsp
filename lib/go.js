...
;(function goScript () {
    ...
    go.isWorker = function () { 
        return go.isNode() ? !!process.send : window.document === undefined;
    };
    ...
    ['Arguments', 'Function', 'Generator', 'String', 'Number', 'Date', 'RegExp'].forEach(function(name) {
